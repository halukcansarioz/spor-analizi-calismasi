...
- **Experience:** 6 months Full Stack development with Ruby on Rails
...
```bash
git clone https://github.com/halukcansarioz/spor-analizi-calismasi.git
```

**2. Navigate to the project directory:**
```bash
cd spor-analizi-calismasi
```
...
jupyter notebook
```
Open the `veri_madenciliği.ipynb` file in your browser.

### Using Google Colab
To run the notebook directly in your browser without any installation, click the **"Open in Colab"** badge above.
...
2. Create a **Branch** (`git checkout -b feature/NewAnalysis`).
3. Make your changes and **Commit** (`git commit -m 'Add: New analysis'`).
4. **Push** your code (`git push origin feature/NewAnalysis`).
